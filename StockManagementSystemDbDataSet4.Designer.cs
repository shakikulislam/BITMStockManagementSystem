...
namespace StockManagementSystem {
    ...
    public partial class StockManagementSystemDbDataSet4 : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemsRow AddItemsRow(int ID, string Name, string ReorderLevel) {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND" +
                " [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ReorderLevel = 1 AN" +
                "D [ReorderLevel] IS NULL) OR ([ReorderLevel] = @Original_ReorderLevel)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([ID], [Name], [ReorderLevel]) VALUES (@ID, @Name, @Reo" +
                "rderLevel);\r\nSELECT ID, Name, ReorderLevel FROM Items WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [ID] = @ID, [Name] = @Name, [ReorderLevel] = @ReorderLevel WHERE (([ID] = @Original_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ReorderLevel = 1 AND [ReorderLevel] IS NULL) OR ([ReorderLevel] = @Original_ReorderLevel)));
SELECT ID, Name, ReorderLevel FROM Items WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, ReorderLevel FROM dbo.Items";
        ...
        public virtual int Fill(StockManagementSystemDbDataSet4.ItemsDataTable dataTable) {
        ...
        public virtual StockManagementSystemDbDataSet4.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StockManagementSystemDbDataSet4.ItemsDataTable dataTable = new StockManagementSystemDbDataSet4.ItemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StockManagementSystemDbDataSet4.ItemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_ReorderLevel) {
        ...
        public virtual int Insert(int ID, string Name, string ReorderLevel) {
        ...
        public virtual int Update(int ID, string Name, string ReorderLevel, int Original_ID, string Original_Name, string Original_ReorderLevel) {
            ...
            if ((Original_ReorderLevel == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_ReorderLevel));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string ReorderLevel, int Original_ID, string Original_Name, string Original_ReorderLevel) {
            return this.Update(Original_ID, Name, ReorderLevel, Original_ID, Original_Name, Original_ReorderLevel);
        }
    }
